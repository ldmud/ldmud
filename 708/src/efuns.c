...
/*-------------------------------------------------------------------------*/
static object_t *
object_present_in (char *str, object_t *ob, Bool hasNumber, p_int num)
...

{
    ...
    ret_ob = object_present_in(v->u.string, ob->contains, hasNumber, num);
    if (ret_ob)
        return ret_ob;
    ...
    if (!specific && ob->super)
    {
        ...
        return object_present_in(v->u.string, ob->super->contains, hasNumber, num);
    }
