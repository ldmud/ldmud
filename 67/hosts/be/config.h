 ...
 * If used, select values between 300 and 600 seconds (5 to 10 minutes).
 * Select a value <= 0 or undefine the macro to turn off
 * the watchdog feature.
 *
 * DANGER! The real-time behaviour of LPMud is very unpredictable,
 * and this feature is nothing more than a simple emergency break.
 * If your mud has objects which can't recover from such an interruption,
