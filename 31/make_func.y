...
/* #define FUNC_TOKENS  "efun_tokens.y" */
  /* TODO: This is unused, but it could be used for the efun_defs.c file
   * TODO:: which is currently just dumped to stdout.
   */
...
#define THE_INSTRS   "instrs.h"
  /* The instruction and ctype tables to generate.
   */
...
#define MAX_ARGTYPES  500
   ...
   * TODO: Add overflow checks where appropriate.
   */
...
static int arg_types[MAX_ARGTYPES];
   ...
   * into efun_defs.c and used by the instrs[].arg_index entries.
   */
...
");
    ...
    /* TODO: This safeguard can go away if we write efun_defs.c directly */
    printf(
"#if 0\n"
"/* Any text you see in this block was printed during \n"
" * the test of " YACC ". Just ignore it.\n"
" */\n"
          );
    fflush(stdout);
...
"struct instr instrs[] = {\n"
    ...
    printf("/* Aliased efuns\n */\n\n");
    printf("short efun_aliases[] = {\n");
...
" */\n\n"
    ...
    printf("/* Prototypes of the tabled efuns\n */\n\n");
    ...
    while (k < j)
    {
        printf("extern struct svalue *f_%s(struct svalue *);\n", key[k++]);
    }
    printf("\n\n");

    printf("/* The table of tabled efuns\n */\n\n");
    printf("struct svalue *(*efun_table[]) (struct svalue *) = {\n");
    while(i < j) {
        printf("  f_%s,\n", key[i++]);
    }
    printf("};\n\n\n");

    printf("/* Prototypes of the tabled vararg efuns\n */\n\n");
    j = i + num_instr[C_VCODE] + num_instr[C_VEFUN];
    k = i;
    while(k < j) {
        printf("extern struct svalue *f_%s(struct svalue *, int);\n", key[k++]);
    }
    printf("\n\n");

    printf("/* The table of tabled vararg efuns\n */\n\n");
    printf("struct svalue *(*vefun_table[])(struct svalue *, int) = {\n");
    while(i < j) {
        printf("  f_%s,\n", key[i++]);
    }
    printf("};\n\n\n");
...
"   */\n\n"
    ...
    fprintf(fpw,
"  /* Both tables are defined in efun_defs.c and compiled into lex.c\n"
"   */\n\n"
           );
...
"#endif /* __INSTRS_H__ */\n"
    ...
    /* TODO: Match for the first '%{' line and add a 'DO NOT EDIT'
     * TODO:: header.
     */
