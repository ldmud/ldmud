...
struct svalue assoc_shared_string_key; /* TODO: Make me a local static */
   ...
   * heavily used). This should better be done by static initialisation,
   */
...

{
	...
	if (len < 1) {
	    ...
	    for (num = 1, p = str; (p = strchr(p, c)); p++, num++) NOOP;
