...
#if ( defined( atarist ) && !defined ( minix ) ) || defined( MSDOS ) || defined(__CYGWIN__) || defined(__EMX__) || defined(OS2)
#define MSDOS_FS
#endif
...
#if (defined(AMIGA) && !defined(__GNUC__)) || defined(__CYGWIN__) || defined(__EMX__) || defined(OS2)
