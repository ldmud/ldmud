...
static /* TODO: BOOL */ int did_swap;
   ...
   */
          ...
          )
    {
        ...
        /* TODO: BOOL */ short bResetCalled;  /* reset() or cleanup() called */
...
no_clean_up: NOOP;
        ...
        /* If reset() or cleanup() was called in a then swapped-out object,
         * we adjust the obj->time_of_ref so that the object will be swapped
         * out real soon - but not immediately, as the call(s) may have
         * triggered new activity.
         * 'real soon' means in this case 0.5*min(reset_delay, swap_delay).
         *
         * If the object was not swapped out, we simply restore the old
         * time_of_ref.
         */
        if (bResetCalled)
        {
