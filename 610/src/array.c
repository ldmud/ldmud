...
#define xRETURN_FUNCTION_NAME    0x01
#define xRETURN_FUNCTION_FLAGS   0x02
#define xRETURN_FUNCTION_TYPE    0x04
#define xRETURN_FUNCTION_NUMARG  0x08

#define xRETURN_FUNCTION_MASK    0x0f  /* union of all RETURN_FUNCTION_ defs */

#define xRETURN_FUNCTION_ARGTYPE 0x10 /* not implemented */
...
#undef FILTERFLAGS
#undef xRETURN_FUNCTION_NAME
#undef xRETURN_FUNCTION_FLAGS
#undef xRETURN_FUNCTION_TYPE
#undef xRETURN_FUNCTION_NUMARG
#undef xxRETURN_FUNCTION_ARGTYPE
#undef xRETURN_FUNCTION_MASK
}
