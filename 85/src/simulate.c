 ...
 */
{
    ...
    if (ob->flags & O_SWAPPED)
    {
        ...
        /* lookfor_object() is also called to find blueprints for
         * inheritance or cloning. Without this update, often used
         * blueprints would start thrashing as the backend would immediately
         * swap them out again.
         */
    }
    return ob;
