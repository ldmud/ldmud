...
static void add_permanent_define(char *, int, void *, Bool);
...
/*-------------------------------------------------------------------------*/
static void
add_permanent_define (char *name, int nargs, void *exps, Bool special)
...

{
    ...
    if (_privilege_violation("set_auto_include_string", sp, sp))
    {
        clear_auto_include_string();
        s = sp->u.string;
