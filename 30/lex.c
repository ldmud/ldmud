...

{
    ...
    add_permanent_define("__FILE__", -1, get_current_file, MY_TRUE);
    add_permanent_define("__LINE__", -1, get_current_line, MY_TRUE);
    add_permanent_define("__VERSION__", -1, get_version, MY_TRUE);
    add_permanent_define("__HOST_NAME__", -1, get_hostname, MY_TRUE);
    add_permanent_define("__DOMAIN_NAME__", -1, get_domainname, MY_TRUE);
    add_permanent_define("__HOST_IP_NUMBER__", -1
                        , get_host_ip_number, MY_TRUE);
    sprintf(mtext, "%d", MAX_USER_TRACE);
    add_permanent_define("__MAX_RECURSION__", -1, string_copy(mtext), MY_FALSE);
    add_permanent_define("__EFUN_DEFINED__", 1, efun_defined, MY_TRUE);
#ifdef ERQ_DEMON
...

{
    ...
    fprintf(stderr, "reallocating defbuf from %ld (%u left) to %ld.\n"
