...

{
    ...
    /* Implementation restriction: lfun and identifier closures can be
     * identical even if their ->u.number value is different, which breaks
     * the assumptions of this code. Therefore we don't allow them in the
     * first place.
     */
    ...
    {
        error("Implementation restriction: Mappings can't use lfun/identifier closures as keys.\n");
        /* NOTREACHED */
        return NULL;
    }
