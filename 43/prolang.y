...
%endif /* INITIALIZATION_BY___INIT */
                    ...
                    /* If the program is inherited virtually, don't insert
                     * it unless it is the first virtual inherit.
                     */
                    found = MY_FALSE;
                    if ($1[1] & TYPE_MOD_VIRTUAL) {
                        ...
                        for (; c_inh >= (struct inherit *)(mem_block[A_INHERITS].block); c_inh--)
                        {
                            /* TODO: Is the virtual_index_offset valid if no
                             * TODO:: variables are declared? */
