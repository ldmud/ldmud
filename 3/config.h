 ...
 */
#define ERQ_DIR "/users/phil/osb/erq"
...
/* The parameters of the regular expression cache.
 * It uses a hashtable of _TABLE entries, each holding a chain of up
 * to _CHAIN cached expressions.
 * Undefine RXCACHE_TABLE to disable the regexp caching.
 */

#define RXCACHE_TABLE 4096  /* Length of the hash table */
#define RXCACHE_CHAIN 2     /* Max size of one hash chain */
