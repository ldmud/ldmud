...
struct condensed_mapping {
     ...
     *
     *   The values associated with the following non-string keys.
     ...
     *   values are all svalue-0; and both are always located at
     ...
     *   memory, the associated values are all svalue-0.
     *
