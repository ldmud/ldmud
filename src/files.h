...
extern svalue_t *f_cat (svalue_t *sp, int num_arg);
...
extern svalue_t *f_read_bytes (svalue_t *sp, int num_arg);
extern svalue_t *f_read_file (svalue_t *sp, int num_arg);
extern svalue_t *f_rename (svalue_t *sp);
extern svalue_t *f_rm (svalue_t *sp);
extern svalue_t *f_rmdir (svalue_t *sp);
extern svalue_t *f_tail (svalue_t *sp);
