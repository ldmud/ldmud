 ...
 *
 *        string DID_MEM_NAME
 *            The name of the allocator: "sysmalloc", "smalloc", "ptmalloc".
 *
 *        int DID_MEM_SBRK          (smalloc)
 *        int DID_MEM_SBRK_SIZE     (smalloc, ptmalloc)
 ...
 *
 *        int DID_MEM_LARGE         (smalloc)
 *        int DID_MEM_LARGE_SIZE    (smalloc)
 ...
 *        int DID_MEM_SFREE_SIZE    (smalloc)
 ...
 *
 *        int DID_MEM_MINC_CALLS    (smalloc)
 *        int DID_MEM_MINC_SUCCESS  (smalloc)
 *        int DID_MEM_MINC_SIZE     (smalloc)
 *            Number of calls to malloc_increment(), the number
 *            of successes and the size of memory allocated this
 *            way.
 *
 *        int DID_MEM_PERM         (smalloc)
 *        int DID_MEM_PERM_SIZE    (smalloc)
 *            Number and size of permanent (non-GCable) allocations.
 *
 *        int DID_MEM_CLIB         (smalloc)
 *        int DID_MEM_CLIB_SIZE    (smalloc)
 *            Number and size of allocations done through the
 *            clib functions (if supported by the allocator).
 *
 *        int DID_MEM_OVERHEAD     (smalloc, ptmalloc)
 *            Overhead for every allocation.
 *
 *        int DID_MEM_ALLOCATED    (smalloc, ptmalloc)
