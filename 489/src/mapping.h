...
extern void remove_mapping(mapping_t *m, svalue_t *map_index, int where);
#else
...
extern void int_check_map_size (mapping_t *m,  const char * tag, const char * file, int line);
#define check_map_size(m, t) int_check_map_size(m, t, __FILE__, __LINE__)
#else
#define check_map_size(m, t) NOOP
#endif

#ifdef CHECK_MAPPINGS
#ifdef GC_SUPPORT
extern void clear_ref_in_msbuf();
extern void count_ref_in_msbuf();
#endif
extern void int_check_cond_del (mapping_t *m, struct condensed_mapping *cm, struct hash_mapping *hm, const char * tag, strbuf_t *sbuf, const char * file, int line);
#define check_cond_del(m, cm, hm, t) int_check_cond_del (m, cm, hm, t, NULL, __FILE__, __LINE__)
#define check_cond_del_b(m, cm, hm, t) int_check_cond_del (m, cm, hm, t, sbuf, __FILE__, __LINE__)
#else
#define check_cond_del(m, cm, hm, t) NOOP
#define check_cond_del_b(m, cm, hm, t) NOOP
#endif

#ifdef CHECK_MAPPING_TOTAL
extern void m_check_total_mapping_size (Bool bFatal, const char * file, int line);
#define check_total_mapping_size() m_check_total_mapping_size(MY_FALSE, __FILE__, __LINE__)
#define assert_total_mapping_size() m_check_total_mapping_size(MY_TRUE, __FILE__, __LINE__)
#else
#define check_total_mapping_size() NOOP
#define assert_total_mapping_size() NOOP
#endif
