 ...
 * a pointer to the ed_buffer in the interactive structure.
 *
...
/* The whole text is stored linewise in a double-linked list of 'line'
...
#define LGLOB    0x02       /* line marked global */
    ...
    struct svalue *sp;
{
    ...
    if (ob->flags & O_SHADOW && NULL != (sent = O_GET_SHADOW(ob)) && sent->ed_buffer) {
