...
extern int  setup_function_callback(callback_t *cb, object_t* ob, char *fun, int nargs, svalue_t * args, Bool delayed_callback);
...
extern void errorf VARPROT((char *, ...), printf, 1, 2) NORETURN;
