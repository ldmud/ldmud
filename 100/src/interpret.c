...
#define MY_LAMBDA_VALUE_OFFSET (sizeof(struct svalue) + \
	 ...
	 * added only recently, to avoid the need for global variables)
         *
         * TODO: Make the flags into symbolic defines and provide
         * TODO:: an include file.
         */
	 ...
	 * Returns the size of the file in bytes.
         *	
	 * Size -1 indicates that the file either does not exist, or that
	 * it is not readable for the calling object/user.
	 * Size -2 indicates that it is a directory.
         *
         * TODO: Make the special returns into defines in an include.
         */
	 ...
	 * The values of mask can be added together.
         *
         * TODO: Put the constants into an include file.
         */
