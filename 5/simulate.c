...
extern int apply_cache_shared, apply_cache_noshared, apply_cache_null; /* TODO: see interpret.c */
#endif
	...
	if (verbose) {
	    ...
	    add_message("%s", print_buff);
            /* TODO: Delete me together with the stuff in interpret.c */
            sprintf(print_buff,
              "DEBUG: %d calls shared, %d unshared, %d invalid.\n\n"
              , apply_cache_shared, apply_cache_noshared, apply_cache_null
              );
            add_message("%s", print_buff);
#endif
	}
