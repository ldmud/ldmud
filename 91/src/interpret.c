 ...
 * The functions are:
 *
 * static _push_object(ob, sp), push_object(ob):
 *   Push a non-destructed object onto the stack.
 * static _push_valid_object(ob, sp), push_valid_object(ob):
 *   Push an object onto the stack.
 * static _put_object(ob, sp):
 *   Put an object onto the stack.
 * static _push_number(n, sp), push_number(n):
 *   Push a number onto the stack.
 * static _push_shared_string(p, sp), push_shared_string(p),
