...
struct svalue *current_variables;
  /* TODO: Pointer to begin of current variable block */
...
static struct svalue indexing_quickfix = { T_NUMBER };
   ...
   * Used by operators: push_(r)indexed_lvalue.
...
static struct replace_ob *retrieve_replace_program_entry(void);
