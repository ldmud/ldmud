...
extern struct svalue *get_map_lvalue(struct mapping *m, struct svalue *map_index, int need_lvalue);
...
extern void walk_mapping(struct mapping *m, void (*func)(struct svalue *, struct svalue *, char *), char *extra);
extern void f_walk_mapping_filter(struct svalue *key, struct svalue *data, char *extra);
extern void f_walk_mapping_cleanup(struct svalue *arg);
extern struct svalue *walk_mapping_prologue(struct mapping *m, struct svalue *sp);
extern struct vector *m_indices(struct mapping *m);
extern void sub_from_mapping_filter(struct svalue *key, struct svalue *data, char *extra);
...
extern struct svalue *filter_mapping(struct svalue *sp, int num_arg);
extern struct svalue *map_mapping(struct svalue *sp, int num_arg);
