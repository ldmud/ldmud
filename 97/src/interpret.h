...
extern /* TODO: BOOL */ int _privilege_violation(char *what, struct svalue *where, struct svalue *sp);
extern /* TODO: BOOL */ int privilege_violation4(char *what, struct object *whom, char *how_str, int how_num, struct svalue *sp);
