...
struct mapping {
    ...
    struct condensed_mapping *condensed;   /* 'clean' part of the mapping */
...
struct hash_mapping {
    p_int mask;  /* Index mask for chains[] */
    p_int used;
 ...
 * TODO: Document its fields and memory layout
 */
