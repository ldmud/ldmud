...
#ifdef OLD_RESET
    time_t next_reset;         /* Time of next reset, or MAXINT if none */
#else
    time_t time_reset;         /* Time of next reset, or 0 if none */
#endif
...
#ifndef OLD_RESET
    struct object *next_reset;  /* Next object in reset list */
#endif
