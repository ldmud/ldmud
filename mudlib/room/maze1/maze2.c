...
e0() {
	...
	call_other(this_player(), "move_player", "north#room/maze1/maze1");
    return 1;
}

e1() {
    if (exit_num == 1)
	call_other(this_player(), "move_player", "south#room/maze1/maze3");
    else
...
e2() {
    if (exit_num == 2)
	call_other(this_player(), "move_player", "east#room/maze1/maze3");
    else
...
e3() {
    if (exit_num == 3)
	call_other(this_player(), "move_player", "west#room/maze1/maze3");
    else
